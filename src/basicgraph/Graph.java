...
public abstract class Graph {
	...
	public List<Integer> degreeSequence() {
		...
		for(int i=0 ; i< this.numVertices ; i++) {
			List<Integer> InDeg = getInNeighbors(i);
			System.out.println("In Neighbors"+" "+ i+" "+getInNeighbors(i));
			System.out.println("In Neighbors"+" "+ i+" "+getNeighbors(i));
			List<Integer> OutDeg = getNeighbors(i);
			ds.add(InDeg.size()+OutDeg.size());
		}
...
//		System.out.println(graphFromFile);
		...
		System.out.println("/data/maps/ucsd.map -----------");
		...
		GraphAdjMatrix GraphFromFile3 = new GraphAdjMatrix();
		GraphLoader.loadRoadMap("data/maps/ucsd.map", GraphFromFile3);
...
//		System.out.println(airportGraph);
		...
		GraphFromFile2.getDistance2(10);
		GraphFromFile3.getDistance2(10);
