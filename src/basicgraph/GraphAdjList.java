...
public class GraphAdjList extends Graph {
	 ...
	 */		
	 public List<Integer> getDistance2(int v) {
		 ...
		 List<Integer> vNeighbors = this.adjListsMap.get(v);
		 List<Integer> vNeighbors2 = new ArrayList<Integer>();
		 if(!vNeighbors.isEmpty()) {
			 for(int n : vNeighbors) {
				 vNeighbors2.addAll(adjListsMap.get(n));
			 }
			 if(vNeighbors2.isEmpty())System.out.println(v+" has no neighbors of distance 2");
			 else System.out.println("neighbors of distance 2 of "+v+" "+vNeighbors2);
		 }else System.out.println(v+" has no neighbors");
